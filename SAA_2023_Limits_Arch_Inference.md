...
For Justeson, Shannon's theory of communication was not just a conceptual framework to reason about theoretical analogies to interpreting the past. He adapted the basic definitions of information theory to derive explicit methodological tools for the nature archaeological data. 

@Justeson1973 provides a wealth of theoretical and methodological insights addressing -- and arguably *answering* -- some of the most prominent theoretical debates in archaeology of the time. It provides a set of quantitative measures by which to assess, with mathematical precision, what we can or cannot say about the past from the data that we have. In short, it *calculates* the limitations of archaeological inference.
