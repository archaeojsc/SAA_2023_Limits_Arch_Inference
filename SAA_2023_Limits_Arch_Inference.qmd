...
The total information entropy $H$ of a system $\cal{X}$, which contains some number of discrete features or attributes ($x_{1}, x_{2}, \ldots x_{n}$), is defined as the negative sum of each attribute's probability $p(x_i)$ of occurence times the log of its probability.
